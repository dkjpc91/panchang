...
class dbSupabaseDownloadeSequence(
    private val updatesDao: UpdatesDao,
    private val supabaseFileDownloader: SupabaseFileDownloader
) {
                            ...
                            if (documentSnapshot != null) {
                                ...
                                coroutineScope.launch {
                                    try {
                                        ...
                                        Log.d(
                                            "dbd",
                                            "Current updates for $filename: $existingUpdate"
                                        )
                                        if (existingUpdate.isNotEmpty() && existingUpdate[0].uniqueString == actions) {
                                            ...
                                            Log.d(
                                                "dbd",
                                                "File out of date or not found, downloading new version: $filename"
                                            )
                                            ...
                                            if (holidayUpdate != null) {
                                                ...
                                                Log.d(
                                                    "dbd",
                                                    "Updated existing record for: $filename"
                                                )
                                            } else {
                                ...
                                if (documentSnapshot != null) {
                                    ...
                                    coroutineScope.launch {
                                        try {
                                            ...
                                            Log.e(
                                                "dbd",
                                                "Error inserting record for $filename: ",
                                                e
                                            )
                                        }
                                    }
    ...
    private fun downloadFile(
        ...
        supabaseFileDownloader.retrieveURL(storagePath, action, localFileName, { downloadedFile ->
    ...
    fun checkFileExistence(fileName: String, homeActivity: Activity): LiveData<Boolean> {
        ...
        fileExistsLiveData.postValue(dbFile.exists())
