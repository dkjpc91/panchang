...
class BhagwatGitaChapterFragment : Fragment() {
    ...
    private lateinit var adapter: GitaChapterAdapter
    ...
    override fun onCreateView(
        ...
        binding = FragmentBhagwatGitaChapterBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val chapterNames = dbHelper.getChapterNames()
        adapter = GitaChapterAdapter(chapterNames)
        binding.gitachapterrecyclerView.adapter = adapter
    }
